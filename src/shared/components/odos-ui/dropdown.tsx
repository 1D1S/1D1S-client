  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'rounded-odos-2 h-auto min-w-[150px] items-center gap-0 bg-white px-3 py-2 inset-ring-[1px] inset-ring-gray-400 data-[placeholder]:text-gray-500 data-[size=default]:h-auto data-[size=sm]:h-auto',
        className
      )}
      {...props}
    >
