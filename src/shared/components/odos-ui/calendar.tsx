    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'size-7 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-gray-100'
        ),
        ...
        day: cn(
          ...
          'size-8 p-0 font-normal aria-selected:opacity-100 hover:bg-main-200'
        ),
        day_range_start:
