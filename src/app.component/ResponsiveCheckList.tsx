 ...
 *
 * CCDS 1.2.7 의 `CheckList` `size`(sm·md·lg)는 단일 값이라 반응형으로 직접
 * 줄 수 없다. 모바일(<lg)은 `sm`(행 30px·12px), 데스크톱은 `md`(기본, 38px·14px)
 * 로 두 인스턴스를 뷰포트별로 토글한다. CheckList 는 내부에서 `useId` 로 항목
