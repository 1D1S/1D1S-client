...
const HEADER_HIDDEN_ROUTES = ['/auth/login'];
const RIGHT_SIDEBAR_HIDDEN_ROUTES = ['/auth/login', '/diary/create', '/mypage', '/challenge/create'];
  ...
  return (
    <div className="flex min-h-screen w-screen flex-col bg-white">
      ...
      {showRightSidebar ? (
        ...
        <main className="min-h-0 min-w-0 flex-1 px-4 pb-4">{children}</main>
      )}
    </div>
  );
}
